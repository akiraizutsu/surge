...
from indicators import (
    compute_rsi, compute_macd, compute_obv,
    compute_drawdown, compute_adx, compute_support_resistance,
)
from tickers_source import (
    get_sp500_tickers, get_nasdaq100_tickers,
    get_nikkei225_tickers, get_growth250_tickers,
)
...
def run_screening(index="sp500", top_n=20, progress_cb=None):
    ...
    for item in ranking:
        ...
        if not is_japan:
            ...
            # Disabled during bulk screening to avoid 30s+ overhead (50 tickers × 0.6s each).
            # Options data is fetched on-demand via the live API endpoint instead.
