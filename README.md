...
騰落率・出来高・移動平均線乖離・MACD・RSI を複合スコアリングし、勢いのある銘柄を自動抽出します。
...
- **3市場対応** — S&P 500 / NASDAQ 100 / 日経225 を個別またはまとめてスクリーニング
- **SQLite 永続化** — スクリーニング履歴・ウォッチリストをローカルDBに保存
- **HSL ベースカラーシステム** — 1色選ぶだけで WCAG AA 準拠の配色を自動生成、ダーク/ライト切替対応
- **ファンダメンタルズ連携** — 上位銘柄の PER・PBR・成長率を自動取得
- **日本語 UI** — Kokyū Design System に基づく読みやすいインターフェース
...
| デザインシステム | [Kokyū](KOKYU-UI-GUIDE.md) — 日本語 UI 最適化 |
